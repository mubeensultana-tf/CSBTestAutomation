...
#  @flow=digital
#  Scenario Outline: Happy flow of single applicant scenario auto approval and primary olb registration "<submissionId>"
...
#  @flow=digital
#  Scenario Outline: Happy flow of two applicant scenario for auto approved submission "<submissionId>"
#    Given : I am at the home page
##   // When : I click on the consumer tab
#    Then : I click on product for "<submissionId>"
#    And : I click on the checkout
...
#      | 1         |
  ...
  @flow=digital
  Scenario Outline: Happy flow of single applicant scenario for review submission "<submissionId>"
    Given : I am at the home page
#   // When : I click on the consumer tab
    Then : I click on product for "<submissionId>"
    And : I click on the checkout
