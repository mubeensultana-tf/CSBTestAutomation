...
public class FundingPageXpath {
    ...
    public static final String ROUTINGNUMBER = "//tf-aba-routing[@t-model='RoutingNumber__c']//input";
    public static final String ACCOUNTCHECKING = "//tf-radio[@value='CHECKING']//input";
    public static final String ACCOUNTSAVING = "//tf-radio[@value='SAVINGS']";
    public static final String ACCOUNTNUMBER = "//tf-account-number[@t-model='AccountNumber__c']//input";
}
